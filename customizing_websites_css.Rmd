...
In order to make those changes, we need to dive a bit into the world of CSS. Some of you may have already heard of CSS, but what really is it? Let's dive in.
...
.center[
<span style="color: #5F9EA0;">Rendered as:</span> <em>Welcome to your first MEDS mini-workshop</em>
]

<br>

.footnote[
In R Markdown syntax: `*Welcome to your first MEDS mini-workshop*` --> *Welcome to your first MEDS mini-workshop*
...
.center[
<span style="color: #5F9EA0;">Rendered as:</span> <em>Welcome to your first <strong>MEDS</strong> mini-workshop</em>
]
...
#### **HTML**
* [Getting started with HTML, by MDN Web Docs](https://developer.mozilla.org/en-US/docs/Learn/HTML/Introduction_to_HTML/Getting_started)

#### **CSS**
* [What is CSS?, by MDN Web Docs](https://developer.mozilla.org/en-US/docs/Learn/CSS/First_steps/What_is_CSS)
* [Distill: Custom CSS Styles](https://rstudio.github.io/distill/website.html#custom-style)
